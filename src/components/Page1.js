...
const Page1 = ({ onNext, onBack }) => {
    const [selected, setSelected] = useState(null);
    return (_jsxs("div", { className: "page", children: [_jsx("h1", { className: "title", children: "\uD83D\uDC96You are so special to me for\uD83D\uDC96" }), !selected ? (_jsx("div", { className: "card-grid", children: cardData.map((card) => (_jsxs("div", { className: "love-card", onClick: () => setSelected(card.id), children: [_jsx("img", { src: card.img, alt: card.title }), _jsx("h3", { children: card.title }), _jsx("p", { children: card.caption })] }, card.id))) })) : (_jsxs("div", { className: "detail-view", children: [_jsxs("div", { className: "detail-text", children: [_jsx("h2", { children: cardData[selected - 1].title }), _jsx("p", { children: cardData[selected - 1].description }), _jsx("button", { onClick: () => setSelected(null), children: "Back to cards" })] }), _jsx("div", { className: "detail-image", children: _jsx("img", { src: cardData[selected - 1].img, alt: "detail" }) })] })), _jsxs("div", { className: "nav-buttons", children: [_jsx("button", { className: "love-button", onClick: onBack, children: "\u2B05 Back" }), _jsx("button", { className: "love-button", onClick: onNext, children: "Next \u27A1" })] })] }));
};
